...
if __name__ == '__main__':
    stud = Student("Oleg", "Sergeevich", "Pupkin", Path('lessons.csv'))
    print(stud)
    stud.new_estimate("история", 5)
    stud.new_estimate("физика", 2)
    stud.new_estimate("русский язык", 2)
    stud.new_estimate("физика", 4)
    stud.new_estimate("математика", 5)
    stud.new_estimate("русский язык", 2)
    stud.new_estimate("история", 3)
    stud.new_estimate("физика", 5)
    stud.new_estimate("физика", 2)
    stud.new_estimate("математика", 4)
    stud.new_estimate("математика", 68, "test")
    stud.new_estimate("математика", 99, "test")
    stud.new_estimate("русский язык", 29, "test")
    stud.new_estimate("русский язык", 100, "test")
    stud.new_estimate("химия", 18, "test")
    stud.new_estimate("химия", 74, "test")
    stud.new_estimate("история", 39, "test")
    stud.new_estimate("химия", 89, "test")
    stud.new_estimate("физика", 59, "test")
    print(stud)
